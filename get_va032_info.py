...
try:
    ...
    if info:
        ...
        with open('va032_info.json', 'w', encoding='utf-8') as f2:
            json.dump(output, f2, indent=2, ensure_ascii=False)
        print("Success: Info saved to va032_info.json")
    else:
        print("Error: va_032 not found in character map")
