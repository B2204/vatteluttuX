"""
Process third OCR image
"""
import requests
import json

# Third image path
image_path = r"C:\Users\Asus\.gemini\antigravity\brain\020c1d6e-2a30-45aa-b5bc-e24cf834d439\uploaded_media_1770395881456.png"
...
with open(output_path, 'w', encoding='utf-8') as f:
    if response.status_code == 200:
        ...
        f.write("=" * 60 + "\n")
        f.write("OCR RECOGNITION RESULT - Image 3\n")
        f.write("=" * 60 + "\n\n")
        ...
        # Save JSON
        with open('ocr_result_3.json', 'w', encoding='utf-8') as jf:
